...
DAQ.FiFo.nShots = 100; % number of shots to be acquired in total
...
[ch0Raw,ch1Raw,tS] = DAQ.Acquire_Multi_FIFO_Data(ch0Raw,ch1Raw);

F.DAQ.Close_Connection(); % seems required, otherwise triggering is weird...
